...
function getLocalStorage() {
   ...
   if (localStorage.length > 0) {
      ...
      document.querySelector('[data-rung]').setAttribute('src', 'https://fakeimg.pl/300/')
...
btnAdd.addEventListener('click', (event) => {
   ...
   if (newWidthProcent >= 100) {
      ...
      if (newLvl === 1) {
         ...
         //награда
         document.querySelector('[data-rung]').setAttribute('src', 'https://fakeimg.pl/300/ee4444')
      ...
      if (newLvl === 2) {
         ...
         //награда
         document.querySelector('[data-rung]').setAttribute('src', 'https://fakeimg.pl/300/199885')
      ...
      if (newLvl === 3) {
         ...
         //награда
         document.querySelector('[data-rung]').setAttribute('src', 'https://fakeimg.pl/300/200cff')
      ...
      if (newLvl === 4) {
         ...
         //награда
         document.querySelector('[data-rung]').setAttribute('src', 'https://fakeimg.pl/300/550080')
